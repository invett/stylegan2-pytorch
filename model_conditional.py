...
class Generator(nn.Module):
    def __init__(
        ...
        self.labels_embed = EqualLinear(num_classes, style_dim)
...
class Discriminator(nn.Module):
    def __init__(self, size, channel_multiplier=2, blur_kernel=[1, 3, 3, 1], num_classes=7):
        super().__init__()
        ...
        self.pixel_norm = PixelNorm()
        self.label_embed = EqualLinear(num_classes, channels[4])
