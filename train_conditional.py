...
def train(args, loader, generator, discriminator, g_optim, d_optim, g_ema, device):
    ...
    for idx in pbar:
        ...
        real_labels = torch.nn.functional.one_hot(real_labels, num_classes=args.num_classes).float().to(device)
...
if __name__ == "__main__":
    ...
    discriminator = Discriminator(
        args.size, channel_multiplier=args.channel_multiplier, num_classes=args.num_classes
    ).to(device)
    g_ema = Generator(
        args.size, args.latent, args.n_mlp, num_classes=args.num_classes, channel_multiplier=args.channel_multiplier
    ).to(device)
